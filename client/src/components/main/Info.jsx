            ...
            {homeData.reviews?.map((review, index) => (
              <div key={index} className={info.reviews}>
                  ...
                  <img
                    src={
                      review.user?.profileImage
                        ? `${url}${review.user.profileImage}` // Combine base URL with profile photo path
                        : `${url}default-profile.png` // Default profile picture path
                    }
                  />
                </div>
                <div className={info.reviewBlog}>
                  ...
                  <div className={info.article}>{review.comment}</div>
                </div>
              </div>
            ))}
          </div>
